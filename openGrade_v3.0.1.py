...
def callback():
    ...
    # usr_path = tkinter.filedialog.askopenfile()
    usr_path=askopenfilename(title='Select the diagnostic instrument .exe file', filetypes=[('EXE', '*.exe'), ('All Files', '*')])
    print(usr_path)
...
class App:
    ...
    def update_clock(self):
        ...
        tbody = self.browser.find_elements_by_css_selector(
            "#pane--1 > div > div:nth-child(1) > div.allCourseStatistics > div.el-table.el-table--fit.el-table--border.el-table--enable-row-hover.el-table--enable-row-transition.el-table--small > div.el-table__body-wrapper.is-scrolling-none > table > tbody > tr")
        num = len(tbody)-1
        nglist = []
        titlelist = []
        gradelist = []
        totlist = []
        for i in range(num):
            # print("#pane--1 > div > div:nth-child(1) > div.allCourseStatistics > div.el-table.el-table--fit.el-table--border.el-table--enable-row-hover.el-table--enable-row-transition.el-table--small > div.el-table__body-wrapper.is-scrolling-none > table > tbody > tr:nth-child(%d) > td:nth-child(1)>div" % (i+2))
            title = self.browser.find_element_by_css_selector(
                "#pane--1 > div > div:nth-child(1) > div.allCourseStatistics > div.el-table.el-table--fit.el-table--border.el-table--enable-row-hover.el-table--enable-row-transition.el-table--small > div.el-table__body-wrapper.is-scrolling-none > table > tbody > tr:nth-child(%d) > td:nth-child(1)>div" % (i+2)).text
            grade = self.browser.find_element_by_css_selector(
                "#pane--1 > div > div:nth-child(1) > div.allCourseStatistics > div.el-table.el-table--fit.el-table--border.el-table--enable-row-hover.el-table--enable-row-transition.el-table--small > div.el-table__body-wrapper.is-scrolling-none > table > tbody > tr:nth-child(%d) > td:nth-child(2)>div" % (i+2)).text
            tot = self.browser.find_element_by_css_selector(
                "#pane--1 > div > div:nth-child(1) > div.allCourseStatistics > div.el-table.el-table--fit.el-table--border.el-table--enable-row-hover.el-table--enable-row-transition.el-table--small > div.el-table__body-wrapper.is-scrolling-none > table > tbody > tr:nth-child(%d) > td:nth-child(3)>div" % (i+2)).text
        ...
        if self.lastnum!=num:
            if self.lastnum != None:
                tkinter.messagebox.showinfo("成绩更新","发布了新的成绩")
            self.lastnum=num
